# 3й день проекта: Сегодня каждому в личку писать не буду, Задание
# - написать лайт код на бота залить в гит отправить ссылку в данные по проекту,
# 1 токена быть не должно в коде,
# 2 все def функции название - ваше отчество из фио и имя, но не фамилия.
# 3 мне в личку @название_вашего_бота на проверку работоспособности.
import asyncio
import os
